<template>
  <div class="feeInquiry">
    <el-input v-model="name" placeholder="输入患者姓名"></el-input>
    <el-input v-model="bedNo" placeholder="输入床号"></el-input>
    <el-button type="primary" class="btn">搜索</el-button>
    <el-table class="table" :data="tableData1" style="width: 100%">
    ...
    <el-table class="table" :data="tableData2" style="width: 100%">
      <el-table-column prop="badNo" label="床号" align="center"></el-table-column>
      ...
      <el-table-column prop="allFee" label="总金额" align="center"></el-table-column>
    </el-table>
  </div>
</template>
